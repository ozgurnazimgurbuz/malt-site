...
- **AFTER SHA:** `eec81da4a47dc77005eb64bab3cb2c63c931a3c2`
- **Branch:** `seo-rebuild`
- **Benchmark date:** 2026-08-31T07:35:57Z
- **Python:** 3.9.6
- **Pillow:** 11.3.0
...
## GEO proxy (five-URL mean): **3.133** / 5

| URL | entity | answer | semantic | schema | machine | relations | trust | freshness | extract | mean |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `/` | 4 | 2 | 3 | 4 | 3 | 4 | 4 | 3 | 2 | 3.222 |
| `/hizmetler/tabela/` | 2 | 2 | 4 | 4 | 4 | 4 | 2 | 3 | 2 | 3.0 |
| `/bilgi/tabela-cesitleri/` | 2 | 5 | 5 | 4 | 4 | 4 | 2 | 4 | 4 | 3.778 |
| `/bolgeler/tekirdag/` | 2 | 2 | 3 | 4 | 4 | 4 | 4 | 3 | 2 | 3.111 |
